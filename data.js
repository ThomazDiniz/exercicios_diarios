...
const ROTINA = {
  A: [
    ...
    { id: 'A-alongamento', grupo: 'Alongamento', exercicio: 'Alongamento', equipamento: 'Sem equipamento', observacoes: 'Faça um aquecimento leve e alongue sem dor. Respire fundo e mantenha 20–30s cada posição.', imagem: 'https://www.soufisio.com.br/wp-content/uploads/2018/06/alongamentos-dicas.png', video: null, pinnedFirst: true, pinnedRank: 1 },
    ...
    { id: 'A-abdominal', grupo: 'Abdominal', exercicio: 'Abdominal', equipamento: 'Colchonete', observacoes: 'Crunch: suba só as escápulas, expire ao contrair. Ou prancha para isometria.', imagem: 'https://i.pinimg.com/originals/af/8f/3c/af8f3c6315440188dfe84b5f27646365.gif', video: null },
  ...
  B: [
    ...
    { id: 'B-alongamento', grupo: 'Alongamento', exercicio: 'Alongamento', equipamento: 'Sem equipamento', observacoes: 'Faça um aquecimento leve e alongue sem dor. Respire fundo e mantenha 20–30s cada posição.', imagem: 'https://www.soufisio.com.br/wp-content/uploads/2018/06/alongamentos-dicas.png', video: null, pinnedFirst: true, pinnedRank: 1 },
    ...
    { id: 'B-abdominal', grupo: 'Abdominal', exercicio: 'Abdominal', equipamento: 'Colchonete', observacoes: 'Crunch: suba só as escápulas, expire ao contrair. Ou prancha para isometria.', imagem: 'https://i.pinimg.com/originals/af/8f/3c/af8f3c6315440188dfe84b5f27646365.gif', video: null },
  ...
  C: [
    ...
    { id: 'C-alongamento', grupo: 'Alongamento', exercicio: 'Alongamento', equipamento: 'Sem equipamento', observacoes: 'Faça um aquecimento leve e alongue sem dor. Respire fundo e mantenha 20–30s cada posição.', imagem: 'https://www.soufisio.com.br/wp-content/uploads/2018/06/alongamentos-dicas.png', video: null, pinnedFirst: true, pinnedRank: 1 },
    ...
    { id: 'C-2', grupo: 'Costas', exercicio: 'Remada martelo no banco inclinado com halteres', equipamento: 'Halteres e banco', observacoes: 'Puxe o halter em direção ao quadril, cotovelo próximo ao corpo. Contraia as costas no topo.', imagem: 'https://www.mundoboaforma.com.br/wp-content/uploads/2020/12/costas-remada-martelo-no-banco-inclinado-com-halteres.gif', video: null },
    ...
    { id: 'C-abdominal', grupo: 'Abdominal', exercicio: 'Abdominal', equipamento: 'Colchonete', observacoes: 'Crunch: suba só as escápulas, expire ao contrair. Ou prancha para isometria.', imagem: 'https://i.pinimg.com/originals/af/8f/3c/af8f3c6315440188dfe84b5f27646365.gif', video: null },
  ...
  cardio: [
    ...
    { id: 'cardio-alongamento', grupo: 'Alongamento', exercicio: 'Alongamento', equipamento: 'Sem equipamento', observacoes: 'Faça um aquecimento leve e alongue sem dor. Respire fundo e mantenha 20–30s cada posição.', imagem: 'https://www.soufisio.com.br/wp-content/uploads/2018/06/alongamentos-dicas.png', video: null, pinnedFirst: true, pinnedRank: 1 },
